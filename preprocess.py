...
def SampleDataset(name,TARGET_DIR,TARGET_TRAIN_NUM=200,TARGET_TEST_NUM=50):
    ...
    def enum_dir(src,target_train,target_test):
    ...
    for dir in DIRLIST:
        ...
        enum_dir(typedir,target_train_dir,target_test_dir)
...
if __name__ == "__main__":
    ...
    SampleDataset("sample_4000",TARGET_DIR,3200, 800)
